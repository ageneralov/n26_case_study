...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>ContactSurveyEmailBatch</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ContactSurveyEmailBatch_TEST</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <classAccesses>
        <apexClass>ProductPricingController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ProductPricingController_TEST</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        ...
        <field>Product_Country_Price__c.ATM_Fee_in_other_currencies__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Product_Country_Price__c.Card_Replacement_Cost__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Product_Country_Price__c.Cost_per_Calendar_Month__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Product_Country_Price__c.Country__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Product_Country_Price__c.Product__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Country__c-Countries Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Product_Country_Price__c-Product Country Price Layout</layout>
    </layoutAssignments>
    <objectPermissions>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Product_Country_Price__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <tabVisibilities>
        <tab>Country__c</tab>
    ...
    <tabVisibilities>
        <tab>Product_Country_Price__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
